        ...
        try:
            ...
            for symbol in self.stocks:
                try:
                    ...
                    signal_analyzer = PerformanceAnalyzer(max_investment=self.max_investment)
                    
                    # Process signals and generate trades
                    trades = signal_analyzer.process_signals(df, initial_capital=self.initial_capital)
            ...
            analyzer = PerformanceAnalyzer(max_investment=self.max_investment)
